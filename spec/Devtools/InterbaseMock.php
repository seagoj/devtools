...
if (function_exists('ibase_query')) {
    ...
    runkit_function_redefine('ibase_query', '$connection, $sql',
...
if (function_exists('ibase_fetch_assoc')) {
    runkit_function_redefine('ibase_fetch_assoc', '$qry, $type',
        'static $called = array();
        if ($type !== IBASE_TEXT) {
            return false;
        }
...
if (function_exists('ibase_free_result')) {
    runkit_function_redefine('ibase_free_result', '$qry',
        'switch($qry) {
        case "TEST1":
        case "TEST2":
        case "TEST3":
